...
public void OnLibraryAdded(const char[] name) {
    if (strcmp(name, "LMCCore") == 0 || strcmp(name, "L4D2ModelChanger") == 0) g_bLmcAvailable = true;
}

public void OnLibraryRemoved(const char[] name) {
    if (strcmp(name, "LMCCore") == 0 || strcmp(name, "L4D2ModelChanger") == 0) g_bLmcAvailable = false;
}

public void OnClientCookiesCached(int client) {
    if (g_hGlowCookie != null) g_hGlowCookie.Get(client, g_sSelectedGlow[client], 32);
    if (g_hColorCookie != null) g_hColorCookie.Get(client, g_sSelectedColor[client], 32);
...
void Frame_ApplyGlowAndColor(any userid) {
    ...
    if (client > 0 && IsClientInGame(client)) ApplyGlowAndColor(client);
}
...
public void Event_PlayerBotReplace(Event event, const char[] name, bool dontBroadcast) {
    ...
    if (bot > 0 && IsClientInGame(bot)) CreateTimer(0.1, Timer_ApplyGlow, GetClientUserId(bot), TIMER_FLAG_NO_MAPCHANGE);
}
...
public void Event_BotPlayerReplace(Event event, const char[] name, bool dontBroadcast) {
    ...
    if (player > 0 && IsClientInGame(player)) CreateTimer(0.1, Timer_ApplyGlow, GetClientUserId(player), TIMER_FLAG_NO_MAPCHANGE);
}
...
public void Event_PlayerSpawn(Event event, const char[] name, bool dontBroadcast) { RequestApplyGlow(GetClientOfUserId(event.GetInt("userid"))); }
public void Event_PlayerTeam(Event event, const char[] name, bool dontBroadcast) { RequestApplyGlow(GetClientOfUserId(event.GetInt("userid"))); }
public void Event_PlayerUse(Event event, const char[] name, bool dontBroadcast) { RequestApplyGlow(GetClientOfUserId(event.GetInt("userid"))); }
public void Event_HealBegin(Event event, const char[] name, bool dontBroadcast) { RequestApplyGlow(GetClientOfUserId(event.GetInt("userid"))); RequestApplyGlow(GetClientOfUserId(event.GetInt("subject"))); }
public void Event_HealSuccess(Event event, const char[] name, bool dontBroadcast) { RequestApplyGlow(GetClientOfUserId(event.GetInt("health_restored"))); RequestApplyGlow(GetClientOfUserId(event.GetInt("subject"))); }
public void Event_HealEnd(Event event, const char[] name, bool dontBroadcast) { RequestApplyGlow(GetClientOfUserId(event.GetInt("userid"))); }
public void Event_SurvivorRescued(Event event, const char[] name, bool dontBroadcast) { RequestApplyGlow(GetClientOfUserId(event.GetInt("victim"))); }
public void Event_PlayerLeftStartArea(Event event, const char[] name, bool dontBroadcast) { RequestApplyGlow(GetClientOfUserId(event.GetInt("userid"))); }
public void Event_PlayerLeftCheckpoint(Event event, const char[] name, bool dontBroadcast) { RequestApplyGlow(GetClientOfUserId(event.GetInt("userid"))); }
public void Event_DefibrillatorUsed(Event event, const char[] name, bool dontBroadcast) { RequestApplyGlow(GetClientOfUserId(event.GetInt("subject"))); }
...
public Action Command_RG(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, ""); PrintToChat(client, "\x04[Glow Overlay] \x01Glow disabled."); } return Plugin_Handled; }
public Action Command_WHITE(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "255 255 255"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to White!"); } return Plugin_Handled; }
public Action Command_GREEN(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "0 255 0"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Green!"); } return Plugin_Handled; }
public Action Command_RED(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "255 0 0"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Red!"); } return Plugin_Handled; }
public Action Command_BLUE(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "7 19 250"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Blue!"); } return Plugin_Handled; }
public Action Command_GOLD(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "255 155 0"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Gold!"); } return Plugin_Handled; }
public Action Command_CYAN(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "66 250 250"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Cyan!"); } return Plugin_Handled; }
public Action Command_VIOLET(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "249 19 250"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Violet!"); } return Plugin_Handled; }
public Action Command_MAROON(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "128 0 0"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Maroon!"); } return Plugin_Handled; }
public Action Command_LIME(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "128 255 0"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Lime!"); } return Plugin_Handled; }
public Action Command_YELLOW(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "255 255 0"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Yellow!"); } return Plugin_Handled; }
public Action Command_TEAL(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "0 128 128"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Teal!"); } return Plugin_Handled; }
public Action Command_PINK(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "168 126 255"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Pink!"); } return Plugin_Handled; }
public Action Command_PURPLE(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "155 0 255"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Purple!"); } return Plugin_Handled; }
public Action Command_ORANGE(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "255 90 0"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Orange!"); } return Plugin_Handled; }
public Action Command_RAINBOW(int client, int args) { if (client > 0 && IsClientInGame(client)) { SetGlowShortcut(client, "rainbow"); PrintToChat(client, "\x04[Glow Overlay] \x01Glow set to Rainbow!"); } return Plugin_Handled; }
